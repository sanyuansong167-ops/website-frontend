export const products = [
  ...
  },
  {
    ...
    title: '云台智造 MES',
    sub: '生产执行平台',
    desc: '连接生产现场与经营管理体系，实现全过程透明化管理。',
    tags: ['生产执行透明化', '高级排程优化', '质量追溯闭环'],
    status: '已发布',
    features: [
      '生产执行计划共享',
      '全过程质量管理',
  ...
  },
  {
    ...
    title: '云台 DataHub',
    sub: '企业数据中台',
    desc: '打通业务系统与数据孤岛，构建统一数据资产体系。',
    tags: ['多源数据统一接入', '指标体系建设', '数据资产盘点'],
    status: '已发布',
    features: [
      '多源数据统一接入',
      '实时指标处理',
  ...
  },
  {
    ...
    title: '云台智策 BI',
    sub: '经营决策平台',
    desc: '帮助管理层实时掌握经营状况，实现数据驱动决策。',
    tags: ['经营驾驶舱', '实时分析', '决策支持'],
    status: '已发布',
    features: [
      '经营驾驶舱',
      '数据分析模型',
  ...
  },
  {
    ...
    title: '云台 Agent',
    sub: '企业智能体平台',
    desc: '连接业务系统与企业知识，推动 AI 从工具走向协同伙伴。',
    tags: ['AI业务助手', '知识库问答', '智能分析'],
    status: '即将发布',
    features: [
      '企业知识库',
      '智能问答',
...
export const cases = [
  {
    id: 'tianshan',
    title: '天山材料 - 商混 MVP 平台建设',
    industry: '建材与新材料行业',
    img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=900&auto=format&fit=crop',
    desc: '构建从生产、物流到经营管理的一体化数字平台。',
    tags: ['商混业务一体化', '销售结算', '运输协同'],
    quote: '建设标准统一、数据一致的商混应用底座，支撑区域多站点经营管控和精细化运营。',
  },
  {
    id: 'nanfang',
    title: '南方新材料 - 集团数字化平台建设',
    industry: '建材与新材料行业',
    img: 'https://images.unsplash.com/photo-1494526585095-c41746248156?q=80&w=900&auto=format&fit=crop',
    desc: '沉淀集团企业内部业务系统，实现数据贯通与协同运营。',
    tags: ['ERP一体化', '业务协同', '数据中台'],
    quote: '在业务流程标准化基础上，建立企业级数据支撑能力，提升运营决策效率。',
  },
  {
    id: 'hainang',
    title: '海南核电 - 核电预警系统建设',
    industry: '能源与工程建设行业',
    img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=900&auto=format&fit=crop',
    desc: '建设核电机组预警系统，提升项目安全运营与业务协同能力。',
    tags: ['安全运营', '预警分析', '工程管理'],
    quote: '通过状态监测与预警模型，提升关键工程环节的风险识别与响应能力。',
  },
  {
    id: 'zhongjiao',
    title: '中交二航局 - 工程建设信息化平台',
    industry: '能源与工程建设行业',
    img: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?q=80&w=900&auto=format&fit=crop',
    desc: '构建工程建设信息平台，实现项目过程精细化管控。',
    tags: ['项目协同', '工程数据', '综合管理'],
    quote: '以项目、流程、数据为核心，沉淀工程建设全过程管理能力。',
  },
]

export const timeline = [
  ['2015', '公司成立', '武汉云台数据有限公司成立，落户东湖科技园'],
  ['2016', '服务拓展', '服务广西天泥混凝土集团，打造“砼云”品牌'],
  ...
  ['2024', '商混 MVP', '为天山材料建设商混 MVP 平台'],
  ['2026', 'AI 新阶段', '发布企业智能体产品，开启 AI 创新新阶段'],
]
...
export const navigation = [
  ...
  { id: 'innovation', label: '创新研发体系' },
  { id: 'cases', label: '产品与行业方案' },
  { id: 'about', label: '关于我们' },
  { id: 'contact', label: '联系我们' },
]

export const metrics = [
  { value: '11+', unit: '年', description: '行业数字化实践经验' },
  { value: '100+', unit: '', description: '数字化项目建设经验' },
  { value: '5', unit: '大行业', description: '持续深耕与服务' },
  { value: 'AI', unit: 'Agent', description: '企业智能体产品持续迭代' },
]

export const honors = [
  { name: '国家高新技术企业', iconUrl: '' },
  { name: '湖北省科技创新企业', iconUrl: '' },
  { name: '湖北省人工智能企业', iconUrl: '' },
  { name: '中国光谷3551企业', iconUrl: '' },
]
...
export const siteConfig = {
  ...
  seo: {
    ...
    keywords: '云台数据,企业数字化,智能化建设,AI智能体',
  },
}
...
export const industrySolutions = [
  {
    ...
    customerTags: ['天山材料商混 MVP 平台建设', '南方新材料集团数字化平台建设'],
  },
  {
    name: '能源与工程建设行业',
    iconUrl: '',
    description: '提升项目管理、安全运营与业务协同能力。',
    customerTags: ['海南核电预警系统建设', '中交二航局工程建设信息化平台'],
  },
  {
    name: '医疗健康行业',
    iconUrl: '',
    description: '提升医疗管理与公共卫生服务数字化水平。',
    customerTags: ['区域医疗信息化平台建设'],
  },
  {
    name: '金融服务行业',
    iconUrl: '',
    description: '建设业务管理与数据分析平台。',
    customerTags: ['金融业务系统建设'],
  },
]
...
export const clientLogos = [
  { id: 'tianshan', name: '天山材料', industry: '建材与新材料', logoUrl: '' },
  { id: 'cnnc', name: '中国核电', industry: '能源', logoUrl: '' },
  { id: 'cjsc', name: '长江证券', industry: '金融', logoUrl: '' },
  { id: 'cccc', name: '中交集团', industry: '工程建设', logoUrl: '' },
  { id: 'hubei-tobacco', name: '湖北烟草', industry: '政企服务', logoUrl: '' },
]
...
export const aiCards = [
  ...
  },
  {
    ...
    name: '智能分析',
    title: '智能分析',
    englishName: 'Analytics',
    en: 'Analytics',
    iconUrl: '',
    description: '自动生成分析与决策支持。',
    text: '自动生成分析与决策支持。',
    jumpLink: '',
  },
  {
