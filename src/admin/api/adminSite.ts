...
export const adminSiteModuleConfigs: AdminSiteModuleConfig[] = [
  ...
  },
  {
    key: 'business-blocks',
    title: '业务区块库',
    listPath: '/admin/api/business-blocks',
    createPath: '/admin/api/business-blocks',
    updatePath: '/admin/api/business-blocks/{id}',
    deletePath: '/admin/api/business-blocks/{id}',
    reorderPath: '/admin/api/business-blocks/reorder',
    deleteVersionQuery: true,
  },
  {
    key: 'business-pages',
    title: '业务页面',
    listPath: '/admin/api/business-pages',
    createPath: '/admin/api/business-pages',
    updatePath: '/admin/api/business-pages/{id}',
    deletePath: '/admin/api/business-pages/{id}',
    reorderPath: '/admin/api/business-pages/reorder',
    deleteVersionQuery: true,
  },
  {
    key: 'business-page-blocks',
    title: '页面区块组合',
    listPath: '/admin/api/business-page-blocks',
    createPath: '/admin/api/business-page-blocks',
    updatePath: '/admin/api/business-page-blocks/{id}',
    deletePath: '/admin/api/business-page-blocks/{id}',
    reorderPath: '/admin/api/business-page-blocks/reorder',
    deleteVersionQuery: true,
  },
  {
